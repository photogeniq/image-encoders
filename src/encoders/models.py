...
class ThinetSmall(Encoder):
    ...
    def __init__(self, block_type=ConvBlock, pool_type=nn.MaxPool2d, pretrained=True, **kwargs):
        super(ThinetSmall, self).__init__(self.CONFIG, block_type, pool_type, input_type="RGB", **kwargs)
...
class ThinetTiny(Encoder):
    ...
    def __init__(self, block_type=ConvBlock, pool_type=nn.MaxPool2d, pretrained=True, **kwargs):
        super(ThinetTiny, self).__init__(self.CONFIG, block_type, pool_type, input_type="RGB", **kwargs)
